...
public class Example09 {
	...
	public static void main(String[] args) {
		...
		ImmutableList<TalhaoVO> talhoesFiltrados = FluentIterable.from(fazendas).filter(FILTER_FAZENDAS_TALHAO_ALGODAO).transformAndConcat(new Function<FazendaVO, Iterable<TalhaoVO>>() {
